# uikit-adapter-contract-tests Specification

## Purpose
Define the internal contract-test baseline for adapter helpers, conversation sync behavior, and pinned-message event boundaries so future UIKit refactors preserve current compatibility behavior.
## Requirements
