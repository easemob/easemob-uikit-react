...
// import ShutDown } from '../svgs/logo.svg';
...
// import PlusCircle } from '../svgs/icons/plus_in_circle.svg';
import { ReactComponent as Search } from '../svgs/icons/magnifier2.svg';
...
// import AddFriend } from '../svgs/icons/person_add_fill.svg';
...
import { ReactComponent as CameraFillArrows } from '../svgs/icons/camera_fill_arrows.svg';
...
const getIconNode = (type: keyof typeof ICON_TYPES): ReactNode => {
  switch (type) {
    ...
    case 'SHIELD_STAR':
      ...
      break;
    case 'CAMERA_FILL_ARROWS':
      return <CameraFillArrows></CameraFillArrows>;
      break;
    default:
      return null;
  }
